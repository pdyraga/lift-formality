...
// WHOA NELLY
// CombinableBox, but redone in terms of the reworked HLists in HListies. Other
// than that, zero code differences from Lift's implementation.
